...
2. If you are unable to upload the package to card or install it, then see Caveats, use lower version of converter, comment out unsupported classes or compile your own limited version of AlgTest applet (see for step-by-step JavaCard compile & convert instructions).
...
5. Please consider to send me (petr@svenda.com) results in case your card is not yet in database at http://www.fi.muni.cz/~xsvenda/jcsupport.html
