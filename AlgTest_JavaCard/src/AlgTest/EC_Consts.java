...
public class EC_Consts {
    ...
    public static byte[] EC_F2M_S = null;
    public static byte[] EC_F2M_A = null;
    public static byte[] EC_F2M_B = null;
    public static byte[] EC_F2M_G_X = null;
    public static byte[] EC_F2M_G_Y = null;
    public static byte[] EC_F2M_R = null;  // parameter n in http://www.secg.org/sec2-v2.pdf
    public static short EC_F2M_K = 2;    // parameter h in http://www.secg.org/sec2-v2.pdf
    ...
    // brainpoolP320r1 https://tools.ietf.org/html/rfc5639#page-12
    public static final byte[] EC320_FP_P = new byte[]{
        (byte) 0xD3, (byte) 0x5E, (byte) 0x47, (byte) 0x20, 
    ...
    public static final byte[] EC320_FP_A = new byte[]{
        (byte) 0x3E, (byte) 0xE3, (byte) 0x0B, (byte) 0x56, 
    ...
    public static final byte[] EC320_FP_B = new byte[]{
        (byte) 0x52, (byte) 0x08, (byte) 0x83, (byte) 0x94, 
    ...
    // G in compressed form / first part of ucompressed
    public static final byte[] EC320_FP_G_X = new byte[]{
        (byte) 0x43, (byte) 0xBD, (byte) 0x7E, (byte) 0x9A, 
        (byte) 0xFB, (byte) 0x53, (byte) 0xD8, (byte) 0xB8, 
        (byte) 0x52, (byte) 0x89, (byte) 0xBC, (byte) 0xC4, 
        (byte) 0x8E, (byte) 0xE5, (byte) 0xBF, (byte) 0xE6, 
        (byte) 0xF2, (byte) 0x01, (byte) 0x37, (byte) 0xD1, 
        (byte) 0x0A, (byte) 0x08, (byte) 0x7E, (byte) 0xB6, 
        (byte) 0xE7, (byte) 0x87, (byte) 0x1E, (byte) 0x2A, 
        (byte) 0x10, (byte) 0xA5, (byte) 0x99, (byte) 0xC7, 
        (byte) 0x10, (byte) 0xAF, (byte) 0x8D, (byte) 0x0D, 
        (byte) 0x39, (byte) 0xE2, (byte) 0x06, (byte) 0x11};
    // second part of G uncompressed
    public static final byte[] EC320_FP_G_Y = new byte[]{
        (byte) 0x14, (byte) 0xFD, (byte) 0xD0, (byte) 0x55, 
        (byte) 0x45, (byte) 0xEC, (byte) 0x1C, (byte) 0xC8, 
        (byte) 0xAB, (byte) 0x40, (byte) 0x93, (byte) 0x24, 
        (byte) 0x7F, (byte) 0x77, (byte) 0x27, (byte) 0x5E, 
        (byte) 0x07, (byte) 0x43, (byte) 0xFF, (byte) 0xED, 
        (byte) 0x11, (byte) 0x71, (byte) 0x82, (byte) 0xEA, 
        (byte) 0xA9, (byte) 0xC7, (byte) 0x78, (byte) 0x77, 
        (byte) 0xAA, (byte) 0xAC, (byte) 0x6A, (byte) 0xC7, 
        (byte) 0xD3, (byte) 0x52, (byte) 0x45, (byte) 0xD1, 
        (byte) 0x69, (byte) 0x2E, (byte) 0x8E, (byte) 0xE1};
    // Order of G
    public static final byte[] EC320_FP_R = new byte[]{
        (byte) 0xD3, (byte) 0x5E, (byte) 0x47, (byte) 0x20, 
        (byte) 0x36, (byte) 0xBC, (byte) 0x4F, (byte) 0xB7, 
        (byte) 0xE1, (byte) 0x3C, (byte) 0x78, (byte) 0x5E, 
        (byte) 0xD2, (byte) 0x01, (byte) 0xE0, (byte) 0x65, 
    ...
    // cofactor of G
    public static final short EC320_FP_K = 1;    
    ...
    // brainpoolP512r1 https://tools.ietf.org/html/rfc5639#page-14
    public static final byte[] EC512_FP_P = new byte[]{
    ...
    public static final byte[] EC512_FP_A = new byte[]{
    ...
    public static final byte[] EC512_FP_B = new byte[]{
        (byte) 0x3D, (byte) 0xF9, (byte) 0x16, (byte) 0x10, 
        (byte) 0xA8, (byte) 0x34, (byte) 0x41, (byte) 0xCA, 
        (byte) 0xEA, (byte) 0x98, (byte) 0x63, (byte) 0xBC, 
        (byte) 0x2D, (byte) 0xED, (byte) 0x5D, (byte) 0x5A, 
    ...
    // G in compressed form / first part of ucompressed
    public static final byte[] EC512_FP_G_X = new byte[]{
    ...
    // second part of G uncompressed
    public static final byte[] EC512_FP_G_Y = new byte[]{
    ...
    // Order of G
    public static final byte[] EC512_FP_R = new byte[]{
        (byte) 0xAA, (byte) 0xDD, (byte) 0x9D, (byte) 0xB8, 
        (byte) 0xDB, (byte) 0xE9, (byte) 0xC4, (byte) 0x8B, 
        (byte) 0x3F, (byte) 0xD4, (byte) 0xE6, (byte) 0xAE, 
        (byte) 0x33, (byte) 0xC9, (byte) 0xFC, (byte) 0x07, 
    ...
    // cofactor of G
    public static final short EC512_FP_K = 1;           
    ...
    // sect163r1 as defined in http://www.secg.org/sec2-v2.pdf
    public static final byte[] EC163_F2M_S = new byte[]{
...
/*    
    // sect163r2 as defined in http://www.secg.org/sec2-v2.pdf
    public static final byte[] EC163_F2M_Sxxx = new byte[]{
        (byte) 0x24, (byte) 0xB7, (byte) 0xB1, (byte) 0x37,
        (byte) 0xC8, (byte) 0xA1, (byte) 0x4D, (byte) 0x69,
        (byte) 0x6E, (byte) 0x67, (byte) 0x68, (byte) 0x75,
        (byte) 0x61, (byte) 0x51, (byte) 0x75, (byte) 0x6F,
    ...
    public static final byte[] EC163_F2M_Axxx = new byte[]{
        (byte) 0x07, (byte) 0xB6, (byte) 0x88, (byte) 0x2C,
        (byte) 0xAA, (byte) 0xEF, (byte) 0xA8, (byte) 0x4F,
        (byte) 0x95, (byte) 0x54, (byte) 0xFF, (byte) 0x84,
        (byte) 0x28, (byte) 0xBD, (byte) 0x88, (byte) 0xE2,
    ...
    public static final byte[] EC163_F2M_Bxxx = new byte[]{
        (byte) 0x07, (byte) 0x13, (byte) 0x61, (byte) 0x2D,
        (byte) 0xCD, (byte) 0xDC, (byte) 0xB4, (byte) 0x0A,
        (byte) 0xAB, (byte) 0x94, (byte) 0x6B, (byte) 0xDA,
        (byte) 0x29, (byte) 0xCA, (byte) 0x91, (byte) 0xF7,
    ...
    // G in compressed form / first part of ucompressed
    public static final byte[] EC163_F2M_G_X = new byte[]{
        (byte) 0x03, (byte) 0xF0, (byte) 0xEB, (byte) 0xA1,
        (byte) 0x62, (byte) 0x86, (byte) 0xA2, (byte) 0xD5, 
        (byte) 0x7E, (byte) 0xA0, (byte) 0x99, (byte) 0x11, 
        (byte) 0x68, (byte) 0xD4, (byte) 0x99, (byte) 0x46, 
        (byte) 0x37, (byte) 0xE8, (byte) 0x34, (byte) 0x3E, 
        (byte) 0x36};

    // second part of G uncompressed
    public static final byte[] EC163_F2M_G_Y = new byte[]{
        (byte) 0x00, (byte) 0xD5, (byte) 0x1F, (byte) 0xBC,
        (byte) 0x6C, (byte) 0x71, (byte) 0xA0, (byte) 0x09,
        (byte) 0x4F, (byte) 0xA2, (byte) 0xCD, (byte) 0xD5,
        (byte) 0x45, (byte) 0xB1, (byte) 0x1C, (byte) 0x5C,
        (byte) 0x0C, (byte) 0x79, (byte) 0x73, (byte) 0x24,
        (byte) 0xF1};
    // Order of G
    public static final byte[] EC160_FP_N = new byte[]{
        ...
        if (ecClass == KeyPair.ALG_EC_FP) {
            ...
            switch (ecLength) {
                ...
                case (short) 320: {
                    ...
                    EC_FP_A = EC320_FP_A;
                    EC_FP_B = EC320_FP_B;
                    EC_FP_G_X = EC320_FP_G_X;
                    EC_FP_G_Y = EC320_FP_G_Y;
                    EC_FP_R = EC320_FP_R;
                    EC_FP_K = EC320_FP_K;
                    bParamReady = true;
                    break;
                ...
                case (short) 512: {
                    ...
                    EC_FP_A = EC512_FP_A;
                    EC_FP_B = EC512_FP_B;
                    EC_FP_G_X = EC512_FP_G_X;
                    EC_FP_G_Y = EC512_FP_G_Y;
                    EC_FP_R = EC512_FP_R;
                    EC_FP_K = EC512_FP_K;
                    bParamReady = true;
                    break;
...
/*            
            ...
            switch (ecLength) {
                case (short) 163: {
                    EC_F2M_S = EC163_F2M_S;
                    EC_F2M_A = EC163_F2M_A;
                    EC_F2M_B = EC163_F2M_B;
                    EC_F2M_G_X = EC163_F2M_G_X;
                    EC_F2M_G_Y = EC163_F2M_G_Y;
                    EC_F2M_R = EC163_F2M_R;
                    EC_F2M_K = EC163_F2M_K;  
                    break;
                }
                default: {
                    // Not supported yet
            ...
            // prepare an ANSI X9.62 uncompressed EC point representation for G
            short gSize = (short) 1;
            gSize += (short) EC_F2M_G_X.length;
            gSize += (short) EC_F2M_G_Y.length;
            auxBuffer[0] = 0x04;
            short off = 1;
            off = Util.arrayCopyNonAtomic(EC_F2M_G_X, (short) 0, auxBuffer, off, (short) EC_F2M_G_X.length);
            Util.arrayCopyNonAtomic(EC_F2M_G_Y, (short) 0, auxBuffer, off, (short) EC_F2M_G_Y.length);

            // pre-set basic EC parameters:
            //ecPubKey.setFieldF2M(EC_F2M_S, (short) 0, (short) EC_F2M_S.length); // BUGBUG: what should be set here?
            ecPubKey.setA(EC_F2M_A, (short) 0, (short) EC_F2M_A.length);
            ecPubKey.setB(EC_F2M_B, (short) 0, (short) EC_F2M_B.length);

            ecPubKey.setG(auxBuffer, (short) 0, gSize);
            ecPubKey.setR(EC_F2M_R, (short) 0, (short) EC_F2M_R.length);
            ecPubKey.setK(EC_F2M_K);

            ecPrivKey.setS(EC_F2M_S, (short) 0, (short) EC_F2M_S.length);
            ecPrivKey.setA(EC_F2M_A, (short) 0, (short) EC_F2M_A.length);
            ecPrivKey.setB(EC_F2M_B, (short) 0, (short) EC_F2M_B.length);
            ecPrivKey.setG(auxBuffer, (short) 0, gSize);
...
*/        
    ...
    static void ensureInitializedECCurve(byte keyClass, short keyLen, KeyPair ecKeyPair, byte[] auxArray) {
