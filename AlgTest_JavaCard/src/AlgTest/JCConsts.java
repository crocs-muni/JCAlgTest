...
public class JCConsts { 
    ...
    //  -- No Fields --
    // javacard.security.AESKey Methods:
    ...
    public static final short DSAKey_setG                                           = 1;
    public static final short DSAKey_getG                                           = 2;
    public static final short DSAKey_getQ                                           = 3;
    public static final short DSAKey_setP                                           = 4;
    public static final short DSAKey_getP                                           = 5;
    public static final short DSAKey_setQ                                           = 6;
    ...
    public static final short ECKey_setG                                            = 2;
    public static final short ECKey_getG                                            = 3;
    public static final short ECKey_setB                                            = 4;
    public static final short ECKey_setFieldFP                                      = 5;
    public static final short ECKey_getR                                            = 6;
    public static final short ECKey_getA                                            = 7;
    public static final short ECKey_getK                                            = 8;
    public static final short ECKey_getB                                            = 9;
    public static final short ECKey_setK                                            = 10;
    public static final short ECKey_setA                                            = 11;
    public static final short ECKey_setR                                            = 12;
    public static final short ECKey_setFieldF2M                                     = 13;
    public static final short ECKey_setFieldF2M_2                                   = 14;
    ...
    public static final short RSAPrivateCrtKey_setDQ1                               = 2;
    public static final short RSAPrivateCrtKey_getQ                                 = 3;
    public static final short RSAPrivateCrtKey_getPQ                                = 4;
    public static final short RSAPrivateCrtKey_getDQ1                               = 5;
    public static final short RSAPrivateCrtKey_setP                                 = 6;
    public static final short RSAPrivateCrtKey_getDP1                               = 7;
    public static final short RSAPrivateCrtKey_getP                                 = 8;
    public static final short RSAPrivateCrtKey_setPQ                                = 9;
    public static final short RSAPrivateCrtKey_setQ                                 = 10;
    ...
    public static final short RSAPrivateKey_getModulus                              = 2;
    public static final short RSAPrivateKey_setExponent                             = 3;
    ...
    public static final short RSAPublicKey_getModulus                               = 2;
    public static final short RSAPublicKey_setExponent                              = 3;
    ...
    public static final short SignatureMessageRecovery_sign                         = 5;
    public static final short SignatureMessageRecovery_getAlgorithm                 = 6;
    public static final short SignatureMessageRecovery_beginVerify                  = 7;    
} 
