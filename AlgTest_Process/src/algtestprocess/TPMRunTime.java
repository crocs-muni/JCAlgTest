        ...
        while ((line = reader.readLine()) != null) {
            if (line.startsWith("TPM2_")) { // new command
                ...
                if (fields[1].contains("ECC")) {
                    int ecc_index = fields[1].indexOf("0x");
                    int curve_id = Integer.parseInt(fields[1].substring(ecc_index + 2), 16);
                    fields[1] = fields[1].substring(0, ecc_index) + TPM2_ECC_CURVE_STR.get(curve_id).substring(9); // skip TMP2_ECC_
                }
                html += "\t<tr><td><b>" + fields[1] + "</b></td>";
                ...
                fields = line.trim().split(";");
                assert fields.length >= 6;
                html += "<td class=\"minor\"></td><td class=\"minor\">" + Integer.valueOf(fields[2]) + "</td>";
                html += "<td class=\"minor\">" + Integer.valueOf(fields[4]) + "</td>";
                html += "<td class=\"minor\">" + Integer.valueOf(fields[6]) + "</td>";
                html += "</tr>\n";
            }
        }
        if (inTable) {
