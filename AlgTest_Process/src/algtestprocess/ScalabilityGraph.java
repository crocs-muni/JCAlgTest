...
public class ScalabilityGraph {  
    ...
    private static void addCardInfo(FileOutputStream file, String name) throws IOException{
        ...
        toFile.append("\t\t\t<p>This page was generated by JCAlgTest tool</p>\n");
    ...
    public static void generateScalabilityMain(String dir, List<String> namesOfCards) throws IOException {
        ...
        toFile.append("\t\t<div class=\"alert alert-warning\" role=\"alert\"><strong>It may take a few seconds to load all graphs on page</strong> (depends on the number of graphs).<br> You can find detail test results in <a href=\"./run_time/execution-time.html\"></a> section.\n </div>\n");
        toFile.append("\t\t\t</div>\n");
